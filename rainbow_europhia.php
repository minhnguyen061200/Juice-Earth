...
<head profile="http://www.w3.org/1999/xhtml/vocab">
  ...
  <title>Rainbow Europhia | Juice Earth</title>
            ...
            <div class="views-row views-row-1 views-row-odd views-row-first product-row">
              ...
              <div class="col-sm-4 juice-list hidden-xs">
                <div class="field-header-image">
                  <div class="zoom">
                    <img src="images/rainbow_europhia.jpg" width="420" height="auto" alt=""/>
                  </div>
                </div>
                <div
              ...
              <div class="col-sm-4 organic">
                <h2>Rainbow Europhia</h2>

                <div class="visible-xs-block"><br/></div>

                <p style="margin-top: 20px; text-align: justify">
                  If you are tired of telling your children not to eat more sweeteners, this colorful package is absolutely a perfect solution.
                  Despite those eye-catching colors, this package is produced completely from natural ingredients, and has no food dyes or artificial chemicals.
                  Not only sweetener-free but also full of nutrients, you will have no worry when allowing your children to drink these juices every single day.
                </p>
                ...
                <div class="row">
                  ...
                  <div class="middle">
                    <div class="bar-container">
                      <div style="width: 84.7%; height: 18px; background-color: #4CAF50;"></div>
                    </div>
                  </div>
                  <div class="side right">200
                  </div>
                  <div class="side">
                    <div>4 star</div>
                  </div>
                  <div class="middle">
                    <div class="bar-container">
                      <div style="width: 11.4%; height: 18px; background-color: #4CAF50;"></div>
                    </div>
                  </div>
                  <div class="side right">27
                  </div>
                  <div class="side">
                    <div>3 star</div>
                  </div>
                  ...
                  <div class="middle">
                    <div class="bar-container">
                      <div style="width: 0.4%; height: 18px; background-color: #4CAF50;"></div>
                    </div>
                  </div>
                  ...
                  <div class="middle">
                    <div class="bar-container">
                      <div style="width: 1.3%; height: 18px; background-color: #4CAF50;"></div>
                    </div>
                  </div>
                  ...
                  <form class="commerce-add-to-cart commerce-cart-add-to-cart-form-166 add-to-cart-form-widget"
                    ...
                    <div><input type="hidden" name="form_build_id"
                      ...
                      <div class="product-summary" data-clampedwidth=".add-to-cart-form-widget">
                        <h4 class="">Rainbow Europhia - $135.00 /Week </h4>
                    ...
                    <div class="cart-widget-row">
                      ...
                      <button class="btn-block btn btn-default form-submit" id="edit-submit" name="op"
                              value="Add to cart" type="submit" onclick="addToCart(4)">Add to cart
                      </button>
                    </div>
